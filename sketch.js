...
if(keyIsDown(RIGHT_ARROW)){
  ...
  /*if(collide(package,ground,80)==true)
  {
    World.remove(engine.world,package);
  ...
  /*gameOver()
    swal({
      title: `Gameover`,
      text: "Oops you did'nt save the boy from the flood....!!!",
      imageUrl:
...
function gameOver() {
  if(collide(package, ground)==true){
    World.remove(engine.world,package);
    package = null;
    text("GAMEOVER!");
    //swall();
    ...
    function swall() {
      swal({
          title: `Game Over!!!`,
          text: "Oops, you didnt save the boy from the flood...!!",
